...
export default function Content() {
    return (
        <div className="relative isolate overflow-hidden bg-white py-24 sm:py-32">
            ...
            <div id="business" className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    {/* <p className="text-lg font-semibold leading-8 tracking-tight text-indigo-600">Deploy faster</p> */}
                    <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">The Business</h1>
                    <p className="mt-6 text-xl leading-8 text-gray-700">
                        SANPEC was founded to improve the resilience and reliability of power grid systems and has been privately owned and operated since 2009. Our unique approach, "SANPEC" allows us to create, measure, transfer, and recreate knowledge effectively.
                    </p>
                </div>
            ...
            <div id="vision" className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    {/* <p className="text-lg font-semibold leading-8 tracking-tight text-indigo-600">Deploy faster</p> */}
                    <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Vision & Mission</h1>
                    <p className="mt-6 text-xl leading-8 text-gray-700">
                        SANPEC was founded to improve the resilience and reliability of power grid systems and has been privately owned and operated since 2009. Our unique approach, "SANPEC" allows us to create, measure, transfer, and recreate knowledge effectively.
                    </p>
                </div>
            ...
            <div id="info" className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    {/* <p className="text-lg font-semibold leading-8 tracking-tight text-indigo-600">Deploy faster</p> */}
                    <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">The Sanpec Edge</h1>
                    <p className="mt-6 text-xl leading-8 text-gray-700">
                        SANPEC was founded to improve the resilience and reliability of power grid systems and has been privately owned and operated since 2009. Our unique approach, "SANPEC" allows us to create, measure, transfer, and recreate knowledge effectively.
                    </p>
                </div>
            ...
            <div id="core" className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    {/* <p className="text-lg font-semibold leading-8 tracking-tight text-indigo-600">Deploy faster</p> */}
            ...
            <div id="social" className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    {/* <p className="text-lg font-semibold leading-8 tracking-tight text-indigo-600">Deploy faster</p> */}
                    <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Social Impact</h1>
                    <p className="mt-6 text-xl leading-8 text-gray-700">
                        SANPEC was founded to improve the resilience and reliability of power grid systems and has been privately owned and operated since 2009. Our unique approach, "SANPEC" allows us to create, measure, transfer, and recreate knowledge effectively.
                    </p>
                </div>
