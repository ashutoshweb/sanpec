...
"Verify the supplier's intentions to meet the order requirements before the start of fabrication",

"Verify that supplier's quality control, inspection and test capabilities match the need for the project.",

"Resolve discrepancies and deviations from the specs during fabrication and before shipment",

"Independent determination of product conformity/nonconformity.",

"Independent observations of all welding activities for conformance to AWS D1.1 Structural Welding Code.",
...
const takeawayList2 = [
  "Ensure that the customer receives the quality product meeting all expectations",

  "Mitigating Project Risk and Maximizing Profitability (cost savings)",

  "Increases flexibility for changes in workload",

  "Assure improvements in supplier, program, and business performance",

  "Overall quality of supplier’s finished products and materials improves drastically",
          ...
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
            ...
            <div className=" grid max-w-xl grid-cols-1 gap-8 text-base leading-7 text-[#151949] lg:max-w-none lg:grid-cols-2">
              ...
              <div className="py-5 text-base leading-7 text-[#151949]">
                <div className="list-disc text-lg leading-8">
