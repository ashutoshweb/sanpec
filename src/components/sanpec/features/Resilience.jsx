...
const values = [
    {
      name: 'Robust Infrastructure Design :',
      description: 'Developing\n' +
          'and implementing infrastructure designs that are\n' +
          'capable of withstanding a wide range of environmental and man\n' +
          '-\n' +
          'made challenges.',
    ...
    },
    {
      ...
      description: 'Employing sophisticated risk assessment and management strategies to anticipate, prepare for, and mitigate potential disruptions.',
      icon: HandRaisedIcon,
    },
    {
      name: 'Rapid Response Systems :',
