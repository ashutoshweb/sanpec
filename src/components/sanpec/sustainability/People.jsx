...
import peopleConcertImage from '@/custom-images/jordon-conner-tIr-PWgSYB4-unsplash.jpg'
import PeopleImpactSocial from './people/ImpactSocial'
import Image from 'next/image'

const tabs = [
  {
    name: 'Social Impact',
    comp: <PeopleImpactSocial />,
    features: [
      {
...
export default function PeopleSustainable() {
  return (
          ...
          <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
            <figure className="relative isolate pt-6 sm:pt-12">
              ...
              <blockquote className="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
                <p>
                  Sustainability isn&apos;t just about policies; it&apos;s about a
                  commitment to nurturing the potential, dignity, and happiness
                  of every individual in the workplace. When we invest in our
                  people&apos;s growth, well-being, and sense of belonging, we sow
                  the seeds of success, innovation, and a brighter future for
                  all.
                </p>
              </blockquote>
        ...
        <div className="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-white">
              ...
              ensure they endure for future generations
            </p>
          </div>
