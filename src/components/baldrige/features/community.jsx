          ...
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
            <div className="grid max-w-xl grid-cols-1 gap-8 text-base leading-7 text-[#151949] lg:max-w-none lg:grid-cols-2">
              <div>
                ...
                <p className="mt-8">
                  Across the world thousands of power system professionals are
                  taking time out from their jobs in the industry and
                  volunteering their time to collaboratively share their
                  knowledge and experiences for the greater good of the
                  industry.
                </p>
              </div>
              <div>
            ...
            <dl className="mt-16 grid grid-cols-1 gap-x-8 gap-y-12 bg-[#151949] sm:mt-20 sm:grid-cols-2 sm:gap-y-16 lg:mt-28 lg:grid-cols-4">
