...
const services = [
    { name: 'Transmission and Distribution', description: 'Electric power transmission ', href: '/SideBarSanpec', icon: ChartPieIcon },
    { name: 'Manufacturing and Operations', description: 'Speak directly to your customers', href: '#', icon: CursorArrowRaysIcon },
    { name: 'Security', description: 'Dynamic Risk Management', href: '#pricing', icon: FingerPrintIcon },
    { name: 'Integrations', description: 'Connect with third-party tools', href: '#', icon: SquaresPlusIcon },
    { name: 'Renewables', description: 'Explore wind and solar power', href: '#', icon: ArrowPathIcon },
]
const callsToAction = [
            ...
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div className="flex lg:flex-1">
                    <a href="#" className="-m-1.5 p-1.5">
                        ...
                        <img className="h-12 w-auto" src="https://cdn.firespring.com/images/e2e5a88a-f06b-43b7-9f5e-556a83a3d522.png" alt="" />
                    </a>
                </div>
