    ...
    <header className="relative isolate z-10 bg-[#151949] font-poppins ">
      <div className="container mx-auto flex">
        <div className="flex-1">
          <div className="mt-4 3 p-1.5 cursor-pointer">
        ...
        <div>
          <nav className="flex max-w-7xl items-center justify-end pt-6 lg:px-8" aria-label="Global">
            ...
            <div className="hidden lg:flex lg:gap-x-12">
              {navigation.map((item) => (
                  <a key={item.name} href={item.href}
                     className="text-base capitalize font-semibold leading-6 text-white">
                    {item.name}
                  </a>
              ))}
          ...
          <nav className="flex max-w-7xl items-center justify-between p-6 lg:px-8 " aria-label="Global">
            <Popover.Group className="hidden lg:flex lg:gap-x-12">
              <Popover>
                ...
                >
                  <Popover.Panel
                      className="absolute inset-x-0 top-10 -z-10  mt-6 pt-14 shadow-lg ring-1 ring-gray-900/5">
              ...
              {company.map((item) => (
                  <a key={item.name} href={item.href}
                     className="text-base font-semibold leading-6 text-white from-left ">
                    {item.name}
                  </a>
